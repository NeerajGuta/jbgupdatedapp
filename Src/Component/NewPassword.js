...
const NewPassword = () => {
  ...
  const userData1 = async () => {
    let user = await AsyncStorage.getItem('ueserforgot');
  ...
  const updatePassword = async () => {
    try {
      if (!password) {
        return Alert.alert('Please enter passwords');
      }
      if (!confirmpassword) {
        return Alert.alert('Please enter conform passwords');
      }
          ...
          <View style={styles.back}>
            ...
            <View style={styles.regback}>
              ...
              <TouchableOpacity onPress={handlePasswordVisibility}>
                <AntDesign
                  name="eye"
                  style={[styles.icons2, {marginTop: -10}]}
                />
              </TouchableOpacity>
            </View>
            <Text style={styles.contant}>Confirm Password</Text>
            <View style={styles.regback}>
              <Icon name="lock" style={styles.icons} />
