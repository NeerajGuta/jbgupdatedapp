              ...
              {data?.reverse()?.map((ele, index) => {
                return (
                  <View key={index} style={styles.tab}>
                    ...
                    <View style={styles.profiles1}>
                      <Text style={styles.passfont}>Payment Date</Text>
                      <Text style={styles.passfont1}>{formatDateOnly(ele?.createdAt)}</Text>
                    </View>

                    <View style={styles.profiles1}>
                      <Text style={styles.passfont}>Payment Time</Text>
                      <Text style={styles.passfont1}>{formatTimeOnly(ele?.createdAt)}</Text>
                    </View>
                ...
                <ScrollView style={styles.modalBody}>
                  {selectedTransaction && (
                    <>
                      ...
                      <View style={styles.modalRow}>
                        <Text style={styles.modalLabel}>Payment Date & Time:</Text>
